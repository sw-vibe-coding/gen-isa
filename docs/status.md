...
2026-05-09 — saga step 10 (`ibm1130-asm`) complete. `sw-comp-history/sw-ibm1130-asm` pushed: hand-rolled two-pass assembler with all 24 mnemonics, ORG/EQU/DC/END directives, source-position error reporting, and byte-stable round-trip via the `-isa` encode/decode pair.
...
| IBM 1130  | **exists** (`sw-comp-history/sw-ibm1130-isa`, 24 opcodes, 12 tests passing) | **exists** (`sw-comp-history/sw-ibm1130-target`, ABI revised to historical conventions, 15 tests) | **exists** (`sw-comp-history/sw-ibm1130-codegen`, hand-written lowering, 9 tests) | **exists** (`sw-comp-history/sw-ibm1130-asm`, two-pass assembler, 28 tests) | no |
