...
2026-05-09 — saga step 9 (`ibm1130-codegen`) complete. Mid-step ABI revision driven by bitsavers research is captured in `docs/abi-linkage.md`. `sw-comp-history/sw-ibm1130-codegen` pushed: Backend impl with hand-written per-TIR-op lowering for Add/Sub/Mul/SDiv/Load/Store/Icmp/CondBranch/Branch/Call/Return; 8 snapshot tests + 1 smoke test pass; clippy/fmt clean.
...
| IBM 1130  | **exists** (`sw-comp-history/sw-ibm1130-isa`, 24 opcodes, 12 tests passing) | **exists** (`sw-comp-history/sw-ibm1130-target`, ABI revised to historical conventions, 15 tests) | **exists** (`sw-comp-history/sw-ibm1130-codegen`, hand-written lowering, 9 tests) | no | no |
