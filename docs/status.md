...
2026-05-09 — saga step 9 in-progress (`ibm1130-codegen`). Mid-step ABI revision: research against bitsavers listings (IBM 1130 Subroutine Library C26-5929-4) revealed the step-8 invented ABI conflicted with the historical convention that XR3 is the LIBF transfer-vector base. `docs/abi-linkage.md` (this repo) captures the research; `sw-comp-history/sw-ibm1130-target/docs/abi.md` and impls were revised (XR3 reserved, XR2 = single frame base, no separate FP). Codegen scaffolding now resumes on the corrected ABI.
...
| IBM 1130  | **exists** (`sw-comp-history/sw-ibm1130-isa`, 24 opcodes, 12 tests passing) | **exists** (`sw-comp-history/sw-ibm1130-target`, ABI revised to historical conventions, 15 tests) | no | no | no |
